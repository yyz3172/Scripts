#!/bin/sh
# Qwen3-30B-A3B-Instruct-2507/1P2_1D2：单脚本启动 1 个 Decode 实例。与 run_prefill.sh 配套。
# 用法：
...
# --hf-overrides norm_topk_prob：与 run_prefill.sh 相同，规避 CANN MoeGatingTopK 仅支持 renorm=0。
...
model_path="/root/autodl-tmp/models/Qwen3-30B-A3B-Instruct-2507"
