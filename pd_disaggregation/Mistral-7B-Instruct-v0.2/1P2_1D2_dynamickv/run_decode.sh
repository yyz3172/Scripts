#!/bin/sh
# Mistral-7B-Instruct-v0.2/1P2_1D2_dynamickv：单脚本启动 1 个 Decode 实例。与 run_prefill.sh 配套。
# 在原 1P2_1D2 基础上开启 DynamicKV（--additional-config）。
#
# 用法：
#   bash run_decode.sh          # 后台启动 D0 并 wait
