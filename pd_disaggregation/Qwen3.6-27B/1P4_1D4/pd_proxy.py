#!/usr/bin/env python3
"""1P4+1D4 负载均衡代理（Layerwise）：1 个 P（9000）+ 1 个 D（9010），对外 8000。"""
...
# .../code/Scripts/pd_disaggregation/Qwen3.6-27B/1P4_1D4/pd_proxy.py -> parents[4] == code/
_CODE_ROOT = Path(__file__).resolve().parents[4]
PROXY_SCRIPT = (
    _CODE_ROOT
    / "vllm-ascend/examples/disaggregated_prefill_v1/load_balance_proxy_layerwise_server_example.py"
)
